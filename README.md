...
**[LightBnB](https://github.com/callmeteni/LightBnB)**
A multi-page Airbnb-style clone with a Node/Express server rendering property listings from a SQL-backed data layer, plus custom client-side JS components for search, listings, and auth forms.
`Node.js` `Express` `SQL` `jQuery`

**[jungle-rails](https://github.com/callmeteni/jungle-rails)**
A mini e-commerce application built on Rails 6.1, backed by PostgreSQL, with Stripe integration for handling payments and Bootstrap 5 for the UI.
`Ruby on Rails` `PostgreSQL` `Stripe` `Bootstrap`

**[reservation-system](https://github.com/callmeteni/reservation-system)**
An online restaurant reservation platform where customers can browse restaurants, view menus, check available time slots, and book reservations.
`JavaScript`
